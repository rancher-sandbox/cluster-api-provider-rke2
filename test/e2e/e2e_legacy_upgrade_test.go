...
var _ = Describe("Workload cluster creation", func() {
	...
	Context("Creating a single control-plane cluster", func() {
		It("Should create a cluster with legacy version v0.2.7 and perform upgrade to the v0.3.0 version", func() {
			By("Installing legacy boostrap/controlplane provider version")
